...
if (isset ($_GET['customer_id'])) {
    ...
    if (mysqli_num_rows($result_available_agents) > 0) {
        ...
        $update_agent = "UPDATE deliveryAgent set availabilityStatus = 'Busy' WHERE agentID = '$randon_agent_id';";
    ...
    $insert_order = "INSERT INTO `order` (orderID, status, total_price, time, location, customerID, agentID) VALUES
    ('$order_no',DEFAULT, '$totalPrice', DEFAULT, '$order_location', '$cust_id', '$random_agent_id');";
    ...
    header("Location: profile_page.php?customer_id=$cust_id&view_orders");
