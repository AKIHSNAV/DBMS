            ...
            <div class="col-lg-l2 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="number" id="age" class="form-control" placeholder="Enter Age" autocomplete="off"
...
if (isset ($_POST['customer_register'])) {
    ...
    if ($rows_count > 0) {
        ...
        $insert_query = "INSERT INTO customer (first_name, last_name, address_street, address_city, address_state, pincode, phone_no, email, password, dob,age, gender) values ('$first_name','$last_name','$address_street','$address_city','$address_state','$pincode','$phone_no','$email','$password','$dob','$age','$gender');";
