...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <!-- first child -->
        <nav class="navbar navbar-expand-lg bg-info">k
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <span class="nav-link">Welcome <?php echo $agent_name; ?></span>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                <a class="dropdown-item <?php echo $current_status === 'Unavailable' ? 'active' : ''; ?>"
                                    href="index.php?agent_id=<?php echo "$agent_id"; ?>&agent_unavailable">Unavailable</a>
                            </li>
                            <li>
...
<div class="container my-3">
    ...
    if (isset($_GET['agent_unavailable'])) {
        include('agent_unavailable.php');
    }
